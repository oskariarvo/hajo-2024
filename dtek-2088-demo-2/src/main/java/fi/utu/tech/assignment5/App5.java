...
public class App5 {
    ...
    /*
    * a. Tämä on deadlock ja ohjelmassa eri säikeet odottavat samojen lukkojen
    *    vapautumista. Jos esimerkiksi account1 haluaa siirtää account2 rahaa ja
    *    account2 haluaa siirtää account1 rahaa samaan aikaan, niin jäävät molemmat
    *    odottamaan toistensa synkronointilohkojen vapautumista, jolloin mitään
    *    ei tapahdu loppuajon aikana.
    * b. Tämä deadlock voidaan välttää järjestelmällä oliot aina tiettyyn järjestykseen.
    *
    * */
